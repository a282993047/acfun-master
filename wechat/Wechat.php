          ...
          switch ($this->getRequest('event')) {
            ...
            case "CLICK":
              switch ($this->getRequest('EventKey')) {
                case 'user_info':
                  $this->menuFunction('user_info',$this->getRequest('FromUserName'));
                  break;
                case 'course':
                  $this->menuFunction('course',$this->getRequest('FromUserName'));
                  break;
                case 'activity':
                  $this->menuFunction('activity',$this->getRequest('FromUserName'));
                  break;
                case 'contact':
                  $this->menuFunction('contact',$this->getRequest('FromUserName'));
                  break;
                case 'task':
                  $this->menuFunction('task',$this->getRequest('FromUserName'));
                  break;
                default:
                  $this->menuFunction('error',$this->getRequest('FromUserName'));
                  break;
              }
          }
